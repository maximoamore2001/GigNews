...
<!-- ANTIGUO BODY -->
  ...
  <body id="page-top">
    ...
    <!--Side bar -->
    <div id="wrapper">
      <ul class="sidebar  navbar-nav" style="background-color: #32753f;">
          ...
          @if (Session::get('array_menu')[$i]->id_padre == 0)
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ Session::get('array_menu')[$i]->url }}">
                  ...
                  <span style="color:#fff; font-weight: 800;"> {{ Session::get('array_menu')[$i]->nombre }}</span>
                </a>
              @else
      ...
      <div style="background-color: #c5c5c5;" id="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 style="color: #000;" class="page-header">@yield('titulo')</h1>
            </div>
        </div>
        <div class="row">
          <div class="col-12">
