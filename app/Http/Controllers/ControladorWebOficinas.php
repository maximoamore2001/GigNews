...
class ControladorWebOficinas extends Controller
{
      public function index()
      {
            ...
            return view("web.oficinas", compact("aSucursales", 'aCategorias', 'aPropiedades', 'aPropiedadesMenorMayor', 'aPropiedadesMayorMenor'));
      }
}